            ...
            <div ref={userMenuRef} className="relative hidden sm:block">
              ...
              {userMenuOpen && (
                <div className="absolute right-0 top-full mt-3 w-56 overflow-hidden rounded-2xl border border-slate-200 bg-white/95 text-slate-950 shadow-[0_16px_40px_rgba(15,23,42,0.18)] backdrop-blur-2xl">
                  ...
                  <Link href="/account" onClick={() => setUserMenuOpen(false)} className="block border-b border-slate-200 px-4 py-3 text-sm font-medium text-slate-700 transition-colors hover:bg-slate-50 hover:text-cyan-700">Account settings</Link>
                </div>
              )}
            </div>
          ) : (
            ...
            <div className="mt-1 border-t border-slate-200 pt-2">
              {isLoggedIn && user ? (
                <>
                  ...
                  <Link href="/account" onClick={() => setMenuOpen(false)} className="flex items-center gap-2 rounded-xl px-3 py-2.5 text-sm font-medium text-slate-900 transition-colors hover:bg-slate-100 hover:text-cyan-700">
                    <UserIcon />
                    Account settings
                  </Link>
                </>
